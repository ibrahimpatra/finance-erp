...
export function useSearch(query: string): SearchResult[] {
    ...
    for (const i of incomes) {
      if (
        ...
        results.push({
          ...
          subtitle:     i.source,
          amount:       i.amount,
          currencyCode: i.currencyCode || defaultCode,  // FIX: pass actual currency
          date:         i.createdAt,
        });
      }
    }
    ...
    for (const e of expenses) {
      if (
        ...
        results.push({
          ...
          subtitle:     e.notes,
          amount:       e.amount,
          currencyCode: e.currencyCode || defaultCode,  // FIX: pass actual currency
          date:         e.createdAt,
        });
      }
    }
  ...
  }, [query, incomes, expenses, spentBys, tags, transfers, defaultCode]);
}
